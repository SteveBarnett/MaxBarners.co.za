...
if ($handle = opendir(".")) {
    ...
    if ($file != "." && $file != ".." && $file != "thumbs" && $file != "index.php" && $file != "index2.php" && $file != "index3.php" && $file != ".htaccess" && $file != "2006" && $file != "index4.php" ) {
...
if ($handle = opendir("/home/sub005/sc10611/maxbarners/images/$thumbs/thumbs")) {
    ...
    if ($file != "." && $file != ".." && $file != "thumbs" && $file != "index.php" && $file != "index2.php" && $file != "index3.php" && $file != ".htaccess" && $file != "2006" && $file != "index4.php") {
            ...
            <a href="/images/<?php echo $thumbs; ?>/<?php echo $file; ?>"><img src="/images/<?php echo $thumbs; ?>/thumbs/<?php echo $file; ?>" title="<?php echo $file; ?>" /></a>          
