...
<?php
                ...
                <input name="trt_options[trt_lft_logo]" type="checkbox" value="1" <?php if ( 1 == $options['trt_lft_logo'] ) echo 'checked="checked"'; ?> />
                ...
                <input name="trt_options[trt_description]" type="checkbox" value="1" <?php if ( 1 == $options['trt_description'] ) echo 'checked="checked"'; ?> />
                ...
                <input name="trt_options[trt_diss_ftw]" type="checkbox" value="1" <?php if ( 1 == $options['trt_diss_ftw'] ) echo 'checked="checked"'; ?> />
...
<?php
                ...
                <label>Hide all the Social Icons</label>
                            <input name="trt_options[trt_hide_social]" type="checkbox" value="1" <?php if ( 1 == $options['trt_hide_social'] ) echo 'checked="checked"'; ?> /></p>
...
<br /> 
			...
			<input name="trt_options[trt_hide_fb]" type="checkbox" value="1" <?php if ( 1 == $options['trt_hide_fb'] ) echo 'checked="checked"'; ?> /></p>
...
<br />            
			...
			<input name="trt_options[trt_hide_tw]" type="checkbox" value="1" <?php if ( 1 == $options['trt_hide_tw'] ) echo 'checked="checked"'; ?> /></p>
...
<br />                       
			...
			<input name="trt_options[trt_hide_ms]" type="checkbox" value="1" <?php if ( 1 == $options['trt_hide_ms'] ) echo 'checked="checked"'; ?> /></p>
...
<br />
			...
			<input name="trt_options[trt_hide_ytb]" type="checkbox" value="1" <?php if ( 1 == $options['trt_hide_ytb'] ) echo 'checked="checked"'; ?> /></p>
			...
			<input name="trt_options[trt_hide_flckr]" type="checkbox" value="1" <?php if ( 1 == $options['trt_hide_flckr'] ) echo 'checked="checked"'; ?> /></p>
			...
			<input name="trt_options[trt_hide_rss]" type="checkbox" value="1" <?php if ( 1 == $options['trt_hide_rss'] ) echo 'checked="checked"'; ?> /></p>
			...
			<input name="trt_options[trt_hide_gplus]" type="checkbox" value="1" <?php if ( 1 == $options['trt_hide_gplus'] ) echo 'checked="checked"'; ?> /></p>
...
<?php
            ...
            <div id="tab_misc">
                ...
                <input name="trt_options[trt_diss_sss]" type="checkbox" value="1" <?php if ( 1 == $options['trt_diss_sss'] ) echo 'checked="checked"'; ?> />
                ...
                <input name="trt_options[trt_diss_date]" type="checkbox" value="1" <?php if ( 1 == $options['trt_diss_date'] ) echo 'checked="checked"'; ?> />
                
                </p>
                
                <p class="divider">
                <label style=" font-size:12px; margin:5px 0px;">Hide Category &amp; Tags</label>
                <input name="trt_options[trt_diss_cats]" type="checkbox" value="1" <?php if ( 1 == $options['trt_diss_cats'] ) echo 'checked="checked"'; ?> />
                ...
                <input name="trt_options[trt_diss_fbx]" type="checkbox" value="1" <?php if ( 1 == $options['trt_diss_fbx'] ) echo 'checked="checked"'; ?> />
