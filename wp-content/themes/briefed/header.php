...
<div id="wrapper">
    ...
    <div id="about" class="col-full">
		...
		<?php if ($woo_options['woo_social_twitter']): ?>
			<a class="social-link ico-twitter" href="<?php echo $woo_options['woo_social_twitter']; ?>" title="Twitter">Twitt</a>
		<?php endif; ?>   		
    		<?php if ($woo_options['woo_social_facebook']): ?>
    			<a class="social-link ico-facebook" href="<?php echo $woo_options['woo_social_facebook']; ?>" title="Facebook">Faceb</a>
    		<?php endif; ?>
        	<a class="social-link ico-rss" href="<?php if ( $woo_options['woo_feed_url'] ) { echo $woo_options['woo_feed_url']; } else { echo get_bloginfo_rss('rss2_url'); } ?>" title="Subscribe">RSSfe</a>
