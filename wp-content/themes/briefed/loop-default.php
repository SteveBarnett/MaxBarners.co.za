...
?>
	...
	<div class="post">
        ...
        <div class="posttype">
            ...
            <span class="icon"><a href="<?php echo $category_link; ?>" title="<?php echo esc_attr( get_the_title() ); ?>"><img src="<?php bloginfo('template_directory'); ?>/images/ico-text.png" alt="" /></a></span>
        </div><!-- /.posttype -->
        ...
        <div class="media">
    	    ...
    	    <?php if (get_option('woo_image_link_to') == 'image') {
  			?><a href="<?php echo get_post_meta($post_id, "image", true); ?>" title="<?php echo $meta_data; ?>" rel="lightbox"><?php woo_image('key=image&width='.$width.$height.'&link=img&class='.$align_class); ?></a><?php  
  			} else { ?>
