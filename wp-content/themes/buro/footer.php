	...
	<div id="footer-widgets" class="col-<?php echo $total; ?>">
		...
		<div class="col-full fix">
			...
			<div id="about" class="fix">
    		    ...
    		    <h3><?php echo $woo_options['woo_about_footer_title']; ?></h3>
    		    
    		    <p><?php echo nl2br($woo_options['woo_about_footer_text']); ?></p>
