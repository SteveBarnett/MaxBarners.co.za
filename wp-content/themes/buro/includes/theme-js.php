...
*/
		...
		wp_enqueue_script( 'respond', get_template_directory_uri() . '/includes/js/respond.min.js', array( 'jquery' ) );
		...
		wp_register_script( 'fitvids', get_template_directory_uri() . '/includes/js/jquery.fitvids.js', array( 'jquery' ) );
