...
?>
       ...
       <!-- Widget Effect: Select Input -->
		...
		<!-- Widget Pagination: Checkbox Input -->
	   	...
	   	<!-- Widget Page Template URL: Checkbox Input -->
		<p>
			<label for="<?php echo $this->get_field_id( 'page_url' ); ?>"><?php _e( 'Page Template:', 'woothemes' ); ?></label>
			<?php 
			$args = array(
    						'depth'            => 0,
    						'child_of'         => 0,
    						'selected'         => $instance['page_url'],
    						'echo'             => 1,
    						'name'             => $this->get_field_name( 'page_url' ),
