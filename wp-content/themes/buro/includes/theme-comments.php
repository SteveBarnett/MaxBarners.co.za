	   ...
	   $GLOBALS['comment'] = $comment; ?>
		...
		<li <?php comment_class(); ?>>
	    	...
	    	<a name="comment-<?php comment_ID() ?>"></a>
	      	...
	      	<div id="li-comment-<?php comment_ID() ?>" class="comment-container fix">
	            ...
	            <?php } ?>            
		      	...
		      	<div class="comment-body">
	                ...
	                <span class="comment-head"><?php the_commenter_link() ?> | <?php echo get_comment_date(get_option( 'date_format' )) ?> <?php _e( 'at', 'woothemes' ); ?> <?php echo get_comment_time(get_option( 'time_format' )); ?> <a href="<?php echo get_comment_link(); ?>" title="<?php esc_attr_e( 'Direct link to this comment', 'woothemes' ); ?>">#</a> <?php edit_comment_link(__( 'Edit', 'woothemes' ), '', '' ); ?></span>
